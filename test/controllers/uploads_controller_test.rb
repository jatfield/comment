...
#      post uploads_url, params: { upload: { post_id: @upload.post_id, user_id: @upload.user_id } }
#    end
#
...
#    patch upload_url(@upload), params: { upload: { post_id: @upload.post_id, user_id: @upload.user_id } }
